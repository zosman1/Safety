export let detailsData = {
    ...
    prevent: {
        ...
        youngPeople: {
            ...
            h3: 'Scouting',
            paragraph:
                'Traffickers find victims via social media, shopping malls, bus stops, school, or even through friends.',
            h3: 'Manipulating',
            paragraph:
                'Traffickers will manipulate young people by pretending to be boyfriends or girlfriends, buying presents, treating their intended victims very well, listending and acting interested in their victims lives, and even by lieing.',
            h3: 'Trapping',
            paragraph:
                'Traffickers trick or control young people into staying in the lifestyl by false love or lies, drugs, threats of violence, or actual physical violence.',
        },
        parentsAndAdults: {
            h1: 'The Key to Prevent is Involvement',
            h2:
                'The best way to prevent your child or loved ones from being targeted is to pay attention them and their behavior.',
    ...
    donate: {
        ...
        paragraph:
            'Your gift today provides immediate crisis care and transformative services for a homeless child in need. Here is were you can give back:',
        h4: 'Covenant House',
        h4: 'Blue Campaign',
        h4: 'Worth While Wear',
        h4: 'Unlikely Heroes',
